  ...
  $('.sidebar-menu').append('\
      ...
      <label class="control-label" for=' + inputId + '>' + label + '</label> \
        <div class="input-daterange input-group"> \
          <input class="input-sm form-control" type="text" data-date-language="en" data-date-week-start="0" data-date-format="dd-M-yyyy" data-date-start-view="month" data-initial-date=' + start + ' data-date-autoclose="true"/> \
          <span class="input-group-addon"> to </span> \
          <input class="input-sm form-control" type="text" data-date-language="en" data-date-week-start="0" data-date-format="dd-M-yyyy" data-date-start-view="month" data-initial-date=' + end + ' data-date-autoclose="true"/> \
        </div> \
      </div>');
	
  $('body').append('<script type="text/javascript">$(function () { $("#' + inputId + '").datetimepicker(); }); </script>'); 	
}
